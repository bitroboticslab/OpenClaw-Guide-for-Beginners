...
> 对齐 OpenClaw v2026.6.11-beta.1（最新版本），涵盖 v2026.6.10 稳定版 + v2026.6.11-beta.1 新特性。

### 🌟 新增功能

- ✅ 新增《Fast Talks 自动模式》配置指南（v2026.6.10 标题特性）
- ✅ 新增《Slack Relay 模式集成教程》（v2026.6.11-beta）
- ✅ 新增《Mattermost 原生支持教程》（v2026.6.11-beta）
- ✅ 新增《每 DM 模型覆盖配置》（v2026.6.11-beta）
- ✅ 新增《v2026.6.10 版本变更说明》
- ✅ 新增《v2026.6.11 版本变更说明》

### 🛠️ 优化

- ✅ 全文档默认版本统一更新为 v2026.6.11
- ✅ 更新 README 版本徽章和更新时间
- ✅ 平台对接概览新增 Slack 和 Mattermost 入口
- ✅ v2.1.0 前瞻性内容标注（通道恢复、Provider插件）

## [2.1.1] - 2026-06-27（已合并，无独立tag/release）

> **⚠️ 注**：此版本的修复内容已在仓库历史重建（rebase）时直接合并到对应版本的 commit 中，不再作为独立版本存在。
>
> - v1.9.0 补充的 4 个文档 → 已合入 `v1.9.0` commit
> - v2.0.0 补充的 5 个文档 → 已合入 `v2.0.0` commit
> - v2.1.0 补充的 5 个文档 → 已合入 `v2.1.0` commit
>
> 以下为原始记录，仅供参考。
...
> **📌 说明**：本版本以 OpenClaw v2026.6.9 稳定版为核心对齐目标，exec功能增强为该版本标题特性。其中通道恢复机制、独立Provider插件架构等文档为前瞻性内容，对应功能在 v2026.6.10~v2026.6.11 中正式稳定，提前收录以便用户了解演进方向。
...
- ✅ 新增Telegram富文本投递配置说明
- ✅ 新增Codex原生插件使用指南
- ✅ 新增exec功能增强说明（v2026.6.9 标题特性）
- ✅ 新增通道恢复机制说明（前瞻性，v2026.6.11-beta 稳定）
- ✅ 新增独立Provider插件配置（前瞻性，v2026.6.10+ 稳定）
